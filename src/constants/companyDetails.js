...
export const socialForm = [
  { label: "Facebook", value: "facebook", placeholder: "Enter Link", type: "text" },
  { label: "Instagram", value: "Instagram", placeholder: "Enter Link", type: "text" },
  { label: "LinkedIn", value: "linkedIn", placeholder: "Enter Link", type: "text" },
  { label: "Twitter", value: "twitter", placeholder: "Enter Link", type: "text" },
  { label: "Youtube", value: "youtube", placeholder: "Enter Link", type: "text" },
]