...
import { LuCalendar, LuCircleCheck, LuSchool, LuUsers } from 'react-icons/lu';

const Dashboard = () => {

    return (
        <div className='p-8'>
            <h1 className='text-xl font-semibold sm:text-3xl text-white'>Welcome Super net technology !</h1>
            <div className='w-[90vw] flex justify-between items-center lg:w-full p-5 bg-white/10 rounded-lg mt-10'>
            ...
            <div className='flex flex-col md:flex-row md:justify-center items-center gap-6 md:gap-3 px-5 lg:px-0 mt-6'>
                <div className='w-[90vw] flex flex-col justify-between lg:w-full h-32 p-5 bg-white/10 rounded-lg'>
                    <div className='flex items-center justify-between text-gray-300'>
                        <h2 className='text-xl font-semibold text-white'>User Enquiries</h2>
                        <LuUsers size={25} />
                    </div>
                ...
                <div className='w-[90vw] flex flex-col justify-between lg:w-full h-32 p-5 bg-white/10 rounded-lg'>
                    <div className='flex items-center justify-between text-gray-300'>
                        <h2 className='text-xl font-semibold text-white'>Institute Details</h2>
                        <LuSchool size={25} />
                    </div>
                    <div className='flex items-end justify-between mt-6 text-gray-300'>
                        <div className='font-semibold py-1 px-2 rounded-full flex items-center text-green-400 border border-green-500 text-sm gap-4 bg-green-900/40 backdrop-blur-sm'><p>Added</p><LuCircleCheck /></div>
                        <IoIosArrowDropright size={20} />
                    </div>
                </div>
                <div className='w-[90vw] lg:w-full p-5 bg-white/10 rounded-lg'>
                    <div className='flex items-center justify-between text-gray-300'>
                        <h2 className='text-xl font-semibold text-white'>Upcoming Batches</h2>
                        <LuCalendar size={25} />
